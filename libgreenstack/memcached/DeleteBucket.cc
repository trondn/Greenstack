...
Greenstack::DeleteBucketRequest::DeleteBucketRequest(const std::string &name) : Request(Greenstack::Opcodes::DeleteBucket) {
    if (name.empty()) {
...
Greenstack::DeleteBucketRequest::DeleteBucketRequest() : Request(Greenstack::Opcodes::DeleteBucket) {
}
...
Greenstack::DeleteBucketResponse::DeleteBucketResponse() : Response(Greenstack::Opcodes::DeleteBucket, Greenstack::Status::Success) {

}

Greenstack::DeleteBucketResponse::DeleteBucketResponse(Greenstack::status_t status) : Response(Greenstack::Opcodes::DeleteBucket, status) {
