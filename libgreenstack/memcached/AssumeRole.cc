...
Greenstack::AssumeRoleRequest::AssumeRoleRequest(const std::string &roleName) : Request(Greenstack::Opcodes::AssumeRole) {
    if (roleName.empty()) {
...
Greenstack::AssumeRoleRequest::AssumeRoleRequest() : Request(Greenstack::Opcodes::AssumeRole) {
}
...
Greenstack::AssumeRoleResponse::AssumeRoleResponse() : Response(Greenstack::Opcodes::AssumeRole, Greenstack::Status::Success) {
}

Greenstack::AssumeRoleResponse::AssumeRoleResponse(Greenstack::status_t status) : Response(Greenstack::Opcodes::AssumeRole, status) {
}
