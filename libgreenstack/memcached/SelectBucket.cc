...
Greenstack::SelectBucketRequest::SelectBucketRequest(const std::string &bucketName) : Request(Greenstack::Opcodes::SelectBucket) {
    if (bucketName.empty()) {
...
Greenstack::SelectBucketRequest::SelectBucketRequest() : Request(Greenstack::Opcodes::SelectBucket) {
}
...
Greenstack::SelectBucketResponse::SelectBucketResponse(status_t status) : Response(Greenstack::Opcodes::SelectBucket, status) {
}

Greenstack::SelectBucketResponse::SelectBucketResponse() : Response(Greenstack::Opcodes::SelectBucket, Greenstack::Status::Success) {
}
