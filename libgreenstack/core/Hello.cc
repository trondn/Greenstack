...
Greenstack::HelloRequest::HelloRequest(const std::string &userAgent, const std::string &agentVersion,
                                       const std::string &comment) : Request() {
    if (userAgent.empty()) {
        throw std::runtime_error("User Agent shall be present");
    }

    setOpcode(Greenstack::Opcodes::Hello);
...
Greenstack::HelloRequest::HelloRequest() : Request() {
    setOpcode(Greenstack::Opcodes::Hello);
}
...
Greenstack::HelloResponse::HelloResponse(const std::string &userAgent, const std::string &userAgentVersion,
                                         const std::string &mechanisms) : Response() {
    setOpcode(Greenstack::Opcodes::Hello);
...
Greenstack::HelloResponse::HelloResponse() : Response() {
    setOpcode(Greenstack::Opcodes::Hello);
}
