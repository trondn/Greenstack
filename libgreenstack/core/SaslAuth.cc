...
Greenstack::SaslAuthRequest::SaslAuthRequest(const std::string &mechanism, const std::string &challenge) : Request() {
    setOpcode(Greenstack::Opcodes::SaslAuth);
...
Greenstack::SaslAuthRequest::SaslAuthRequest() : Request() {
    setOpcode(Greenstack::Opcodes::SaslAuth);
}
...
Greenstack::SaslAuthResponse::SaslAuthResponse(const std::string &challenge) : Response() {
    setOpcode(Greenstack::Opcodes::SaslAuth);
...
Greenstack::SaslAuthResponse::SaslAuthResponse() : Response() {
    setOpcode(Greenstack::Opcodes::SaslAuth);
    // @todo fixme
}
...
Greenstack::SaslAuthResponse::SaslAuthResponse(uint16_t status) {
    setOpcode(Greenstack::Opcodes::SaslAuth);
    setStatus(status);
    flatbuffers::FlatBufferBuilder fbb;
    Greenstack::Payload::SaslAuthResponseBuilder builder(fbb);
