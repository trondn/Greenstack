...
namespace Greenstack {
    ...
    class LIBGREENSTACK_PUBLIC_API GetRequest : public Greenstack::Request {
    public:
    ...
    class LIBGREENSTACK_PUBLIC_API GetResponse : public Greenstack::Response {
    public:
        GetResponse();
        GetResponse(status_t status);
