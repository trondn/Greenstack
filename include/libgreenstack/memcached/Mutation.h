...
namespace Greenstack {
    ...
    class LIBGREENSTACK_PUBLIC_API MutationRequest : public Greenstack::Request {
    public:
        MutationRequest();
        ...
        void setDocumentInfo(std::shared_ptr<DocumentInfo> const &documentInfo) {
    ...
    class LIBGREENSTACK_PUBLIC_API MutationResponse : public Greenstack::Response {
    public:
        MutationResponse(cas_t cas, uint32_t size, uint64_t seqno, uint64_t vbucketuuid);
        MutationResponse(status_t status);
