...
namespace Greenstack {
    ...
    class LIBGREENSTACK_PUBLIC_API HelloRequestBuilder {
    public:
    ...
    class LIBGREENSTACK_PUBLIC_API HelloRequest : public Greenstack::Request {
    public:
        HelloRequest(const std::string &userAgent, const std::string &agentVersion,
    ...
    class LIBGREENSTACK_PUBLIC_API HelloResponse : public Greenstack::Response {
    public:
        HelloResponse(const std::string &userAgent, const std::string &agentVersion,
